...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('customer/frontend/manager/order/index', compact('fcSystem', 'seo', 'data'));
    }
    public function detail($id)
    {
        ...
        return view('customer/frontend/manager/order/detail', compact('seo', 'detail', 'fcSystem'));
    }
    public function edit($id)
    {
        ...
        if ($today >= $detail->created_at && $today < \Carbon\Carbon::parse($detail->edited_at)) {
            ...
            return view('customer/frontend/manager/order/edit', compact('seo', 'detail', 'fcSystem', 'products', 'listCity', 'cartCopy'));
        } else {
            return redirect()->route('customer.orders')->with('error', trans('index.OrderDoesNotExist'));
        }
    }
    ...
    public function copy($id)
    {
        ...
        return view('customer/frontend/manager/order/copy', compact('seo', 'detail', 'fcSystem', 'products', 'listCity', 'payments', 'cartCopy'));
    }
    ...
    public function returnOrder(Request $request)
    {
        ...
        if (!empty($cart)) {
            foreach ($cart as $key => $item) {
                ...
                $html .= '<p class="subdued text-xs">' . trans('index.Amount') . ': ' . $item['quantity'] . '</p>';
                ...
                $html .= '</div>
                        ...
                        <div class="w-full md:w-1/2 flex space-x-2 items-center justify-between">
                            ...
                            <div w-1/3>
                                ...
                                <input name="quantity[]" data-price="' . $item['price'] . '" max="' . $item['quantity'] . '" min="0" size="30" type="number" class="border h-9 leading-9 text-black pl-2 focus:outline-none rounded js_change_return_cart" value="0">
                            </div>
