            ...
            <div class="flex justify-between">
                ...
                <div class="">
                    ...
                    <ul class="flex space-x-6">
                        ...
                        <li>
                            ...
                            <a href="tel:{{$fcSystem['contact_hotline']}}" class="flex space-x-2 text-white">
                        ...
                        <li>
                            ...
                            <a href="mailto:{{$fcSystem['contact_email']}}" class="flex space-x-2 text-white">
                ...
                <div class="flex justify-end">
                    ...
                    <ul class="flex space-x-4">
                        ...
                        <li><a href="{{route('customer.dashboard')}}" class="uppercase text-white text-f13">{{Auth::guard('customer')->user()->name}}</a></li>

                        @else

                        <li><a href="{{route('customer.login')}}" class="uppercase text-white text-f13">đăng nhập</a></li>

                        <li><a href="{{route('customer.register')}}" class="uppercase text-white text-f13">đăng ký</a></li>

                        @endif

                        <li><a href="javascript:void(0)" class="relative tp-cart uppercase text-white text-f13">GIỎ HÀNG (<span class="cart-quantity">{{$cart['quantity']}}</span>)</a></li>
        ...
        <div class="flex items-center space-x-10">
            ...
            <div class="w-[200px]">
                ...
                <a href="{{url('/')}}" class="logo-wrapper" title="{{$fcSystem['homepage_company']}}">
                    ...
                    <img src="{{asset($fcSystem['homepage_logo'])}}" alt="{{$fcSystem['homepage_company']}}" class="h-[70px]">
            ...
            <div class="flex-grow">
                ...
                <form method="GET" action="{{route('homepage.search')}}" class="relative">
            ...
            <div>
                ...
                <div class="header-support border-2 border-second px-[25px] h-[45px] relative text-second text-center rounded-l-[45px] rounded-r-none leading-5">
                    ...
                    <span class="font-bold">Gọi ngay {{$fcSystem['contact_hotline']}}</span>
        ...
        <div class="container">
            ...
            <ul class="flex items-center justify-between menu-header static">
                ...
                <li class=" relative">
                    ...
                    <a href="{{url($item->slug)}}" class="text-white text-lg px-5 flex items-center space-x-1">
