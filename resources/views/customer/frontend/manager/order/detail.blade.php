                    ...
                    <div class="flex bg-white md:items-center flex-col md:flex-row justify-between space-y-2 md:space-y-0">
                        ...
                        <div>
                            <div class="flex items-center space-x-1 flex-wrap">
                                ...
                                <span class="text-white font-bold rounded-xl p-1 text-xs <?php echo config('cart.class')[$detail->status] ?>">{{config('cart.status')[$detail->status]}}</span>
                        ...
                        <div class="overflow-x-auto relative mt-2">
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tfoot>
                                    ...
                                    <tr class="">
                                        <th colspan="3" class="p-2 text-right text-base">
                                            <strong>{{trans('index.TotalPrice')}}</strong>
                                        </th>
                                        <td class="p-2">
                                            <strong><span class="text-red-500 font-bold text-2xl">{{number_format($detail->total_price-$detail->total_price_coupon+$detail->fee_ship,0,',','.')}}₫</span></strong>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
