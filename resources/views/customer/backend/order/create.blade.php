                    ...
                    <div class="relative w-full">
                        ...
                        <div class="js_list_product absolute w-full left-0 top-[44px] bg-white shadowC z-50 p-4" style="display: none">
                            ...
                            <div class="mt-2 border-t" id="loadDataProduct">
                                @include('customer.frontend.manager.order.dataProduct')
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table mt-5">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="!pt-6 border-transparent dark:!border-transparent text-right font-medium w-32 js_provisional">{{number_format($detailOrder->total_price,0,',','.')}}₫</td>
                            </tr>
                            <?php
                            $fee_ship = 0;
                            $title_ship = '';
                            ...
                            <tr>
                                ...
                                <td class="border-transparent dark:!border-transparent text-right w-32 text-danger text-xl font-bold cart-total-copy">{{number_format($detailOrder->total_price+$fee_ship,0,',','.')}}₫</td>
                            </tr>
                        </tfoot>
                    </table>
