    ...
    <div class="container px-4 mx-auto w-full flex items-center justify-between">
        <nav class="bg-grey-light w-full" aria-label="breadcrumb">
            <ol class="list-reset flex flex-wrap">
                ...
                @endforeach
                <li><span class="text-gray-500 mx-2">/</span></li>
                <li><a href="<?php echo route('routerURL', ['slug' => $detail->slug]) ?>" class="text-primary">{{ $detail->title}}</a></li>
            </ol>
        </nav>
    </div>
</nav>
<main class="py-8">
    <div class=" container mx-auto px-4">
                        ...
                        <div class="flex flex-col space-y-3">
                            <div class="flex flex-col">
                                <div class="section-subtitle">
                                    <h1 class="font-bold text-2xl pb-2 leading-[1.1]">{{$detail->title}}</h1>
        ...
        <section class="mt-8">
            <h2 class="font-bold text-2xl mb-5">{{trans('index.RelatedProducts')}}</h2>
