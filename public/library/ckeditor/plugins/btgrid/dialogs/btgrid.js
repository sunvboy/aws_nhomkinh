CKEDITOR.dialog.add( 'btgrid', function( editor ) {
  ...
  return {
    ...
    onShow: function() {
      ...
      var rowsInput = this.getContentElement('info', 'rowCount'),rowsInputFlex = this.getContentElement('info', 'rowCountQ'),
      ...
      if (command == 'btgrid') {
        ...
        if (grid) {
          ...
          rowsInputFlex && rowsInputFlex.disable();
    ...
    contents: [
      {
        ...
        elements: [
          ...
          },
          {
            ...
            validate: validatorNum(lang.numRowsError),
            setup: function( widget ) {
              this.setValue( widget.data.rowCountQ );
            },
            commit: function( widget ) {
              widget.setData( 'rowCountQ', this.getValue());
            }
          }
        ]
      }
