...
Route::group(['middleware' => 'locale'], function () {
    Route::group(['prefix' => env('APP_ADMIN'), 'middleware' => ['auth:web']], function () {
        ...
        Route::group(['prefix' => '/products'], function () {
            ...
            Route::get('/excel/export-users', [ProductController::class, 'exportProducts'])->name('products.export');
        });
        //tag
        ...
        Route::get('orders-payment/index', [OrderController::class, 'payment'])->name('orders.payment')->middleware('can:orders_index');
        //cấu hình đơn hàng
        Route::group(['prefix' => '/orders-config'], function () {
            Route::get('index', [OrderController::class, 'configOrder'])->name('orders.config')->middleware('can:orders_index');
            Route::get('edit/{id}', [OrderController::class, 'configOrderEdit'])->name('orders.configEdit')->middleware('can:orders_edit');
            Route::post('update/{id}', [OrderController::class, 'configOrderUpdate'])->name('orders.configUpdate')->middleware('can:orders_edit');
        });
        //hoàn hàng
        ...
        Route::group(['prefix' => '/customers'], function () {
            ...
            Route::get('orders-create/{id}/{orderID}', [BackendOrderController::class, 'orderCreate'])->name('customers.orderCreate')->middleware('can:orders_index');
            Route::post('ajax-list-product', [BackendOrderController::class, 'ajaxListProduct'])->name('customers.ajaxListProduct');
            Route::post('add-to-cart-copy-order', [BackendOrderController::class, 'addToCartCopyOrder'])->name('customers.addToCartCopyOrder');
            Route::post('update-cart-copy-order', [BackendOrderController::class, 'updateCartCopyOrder'])->name('customers.updateCartCopyOrder');
            ...
            Route::post('/get-shipping', [BackendOrderController::class, 'getPriceShip'])->name('customers.getPriceShipAdmin');
            Route::post('/change-shipping', [BackendOrderController::class, 'changePriceShip'])->name('customers.changePriceShipAdmin');
        });
