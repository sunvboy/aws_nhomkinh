    ...
    <div>
        <section class="flex items-center mb-1">
            ...
            <div class="flex flex-col ml-3">
                ...
                <a href="javascript:void(0)" class="font-bold text-xs text-blue-500	">
                    <?php echo e(Auth::guard('customer')->user()->phone); ?>
...
</style><?php /**PATH D:\xampp\htdocs\evox.local\resources\views/customer/frontend/auth/common/sidebar.blade.php ENDPATH**/ ?>