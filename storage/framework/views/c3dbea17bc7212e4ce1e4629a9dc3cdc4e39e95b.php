                    ...
                    <div class="container mx-auto">
                        ...
                        <div class="w-2/5 rounded-[5px] p-5 space-y-2 float-left" style="background: rgba(0, 0, 0, 0.1);">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(url($slide->link)); ?>" class="h-[50px] leading-[50px] border-2 border-white float-left w-[150px] text-center text-white text-base hover:bg-primary hover:border-primary">Xem thêm</a>
        ...
        <div class="container px-4 space-y-[30px]">
            ...
            <div class="text-center">
                ...
                <div>
                    ...
                    <?php echo e(!empty($fields['config_colums_textarea_service_description'])?$fields['config_colums_textarea_service_description']:''); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rosta0607/domains/rosta.vn/public_html/resources/views/homepage/home/index.blade.php ENDPATH**/ ?>