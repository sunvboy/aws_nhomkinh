        ...
        <div class="container px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 -mx-[15px]">
                ...
                <div class="space-y-[30px] mb-[30px] px-[15px]">
                    ...
                    <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset($fcSystem['homepage_logo_footer'])); ?>" alt="logo" style="filter: brightness(0) invert(1);
    width: 50%;"></a>
...
<?php endif; ?><?php /**PATH /home/rosta0607/domains/rosta.vn/public_html/resources/views/homepage/common/footer.blade.php ENDPATH**/ ?>