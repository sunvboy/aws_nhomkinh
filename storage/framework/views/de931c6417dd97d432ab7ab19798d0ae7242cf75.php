...
<main class="">
    <section class="relative">
        <img src="<?php echo asset($detail->image) ?>" alt="<?php echo e($detail->title); ?>" class="w-full h-[170px] md:h-auto object-cover">
        <div class="absolute w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:space-y-3 text-center">
            <h1 class="w-full text-2xl md:text-f40 font-bold text-white uppercase"><?php echo e($detail->title); ?></h1>
            <nav class="bg-grey-light w-full" aria-label="breadcrumb">
                <ol class="flex justify-center">
                    <li><a href="<?php echo e(url('')); ?>" class="text-white hover:text-[#a82cb9]">Trang chủ</a></li>
                    ...
                    <li><a href="<?php echo route('routerURL', ['slug' => $v->slug]) ?>" class="text-white hover:text-[#a82cb9]"><?php echo e($v->title); ?></a></li>
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rosta0607/domains/rosta.vn/public_html/resources/views/media/frontend/category/index.blade.php ENDPATH**/ ?>