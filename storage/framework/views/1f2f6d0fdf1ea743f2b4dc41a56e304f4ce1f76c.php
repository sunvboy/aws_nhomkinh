    ...
    <div class="container px-4 mx-auto w-full flex flex-wrap items-center justify-between">
        <nav class="bg-grey-light w-full" aria-label="breadcrumb">
            <ol class="list-reset flex">
                ...
                <li><span class="text-gray-500 mx-2">/</span></li>
                <li><a href="javascript:void(0)" class="text-gray-500 hover:text-gray-600 text-f13"><?php echo e(trans('index.UpdateOrder')); ?> #<?php echo e($detail->code); ?></a></li>
            </ol>
        </nav>
    </div>
</nav>
    ...
    <div class="container px-4 mx-auto">
        <div class="mt-4 flex flex-col md:flex-row items-start md:space-x-4">
            ...
            <div class="flex-1 w-full md:w-auto order-1 md:order-1">
                <form action="<?php echo e(route('customer.updateOrder',['id'=>$detail->id])); ?>" id="myFormUpdate" method="post">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="relative w-full">
                            ...
                            <div class="js_list_product absolute w-full left-0 top-[44px] bg-white shadowC z-50 p-4" style="display: none">
                                ...
                                <div class="mt-2 border-t" id="loadDataProduct">
                                    <?php echo $__env->make('customer.frontend.manager.order.dataProduct', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col space-y-2">
                            <div class="flex">
                                ...
                                <div class="flex-1 text-right font-bold js_provisional">
                                    <?php echo e(number_format($detail->total_price,0,',','.')); ?>₫
                                </div>
                            </div>
                            <div class="flex">
                        ...
                        <div class="">
                            <div>
                                ...
                                <div class="mt-5 flex justify-end">
                                    <button type="submit" class=" text-center leading-none uppercase bg-red-600 text-white text-sm bg-dark px-10 py-5 transition-all hover:bg-orange font-semibold"><?php echo e(trans('index.UpdateOrder')); ?></button>
...
<script>
    ...
    $.post(BASE_URL_AJAX + 'gio-hang/get-shipping', {
        ...
        function(data) {
            ...
            $('.cart-total-copy').html(numberWithCommas(parseFloat(provisional) + parseFloat(json.fee_ship)) + '₫');
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\evox.local\resources\views/customer/frontend/manager/order/edit.blade.php ENDPATH**/ ?>