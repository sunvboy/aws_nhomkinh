            ...
            <div class="box  p-5 mt-5">
                ...
                <div class="flex items-center border-t border-slate-200/60 dark:border-darkmode-400 pt-5 mt-5 font-medium">
                    ...
                    <div class="ml-auto font-bold text-danger">
                        <?php echo e(number_format($detail->total_price-$detail->total_price_coupon+$detail->fee_ship,0,',','.')); ?>₫
                    </div>
                </div>
            </div>
            <?php if($detail->order_returns): ?>
                    ...
                    <div class="flex flex-col md:flex-row items-center py-4 first:pt-0 last:border-0 last:pb-0 border-b border-dashed border-slate-200 dark:border-darkmode-400">
                        <div class="flex items-center md:mr-auto flex-1">
                            ...
                            <div class="ml-5">
                                ...
                                <div class="text-slate-500 mt-1"><?php echo e($v['quantity']); ?> items x
                    ...
                    <div class="flex flex-col md:flex-row items-center py-4 first:pt-0 last:border-0 last:pb-0 border-b border-dashed border-slate-200 dark:border-darkmode-400">
                        <div class="flex items-center md:mr-auto flex-1">
                            ...
                            <div class="ml-5">
                                ...
                                <div class="text-slate-500 mt-1">Hoàn lại <?php echo e($v['quantity_return']); ?> sản phẩm x
                                    <?php echo e(number_format($v['price'],0,',','.')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\evox.local\resources\views/order/backend/edit.blade.php ENDPATH**/ ?>